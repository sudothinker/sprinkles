package :ruby do
  ...
  source "ftp://ftp.ruby-lang.org/pub/ruby/2.0/ruby-#{version}-p247.tar.gz" do
...
package :ruby_dependencies do
  ...
  apt %w( bison zlib1g-dev libssl-dev libreadline-dev libncurses5-dev libyaml-0-2 file )
end
